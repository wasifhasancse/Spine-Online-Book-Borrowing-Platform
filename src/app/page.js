    ...
    <div className="mx-auto min-h-screen w-full max-w-7xl space-y-12 px-3 py-10 md:space-y-16 md:px-4 md:py-12 lg:space-y-20 lg:px-6 lg:py-14">
      ...
      <section className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_1.1fr] lg:gap-8">
        ...
        <div className="rounded-3xl border border-[#9ac5ee] bg-[#edf5ff]/95 p-5 shadow-xl shadow-[#1f5d991f] md:p-6 lg:p-8">
          ...
          <h2 className="mt-3 text-2xl font-extrabold text-[#1f5d99] md:text-3xl">
            Plan Your Next Borrow
          </h2>
          <p className="mt-3 text-sm leading-relaxed text-[#1f5d99] md:text-base">
            Keep your profile updated, track due dates, and jump directly to
            trending books from one place.
          </p>

          <div className="mt-5 flex flex-col gap-3 md:gap-4">
            <Link
              href="/profile"
              className="inline-flex items-center justify-center rounded-xl bg-[#1f5d99] px-5 py-3 text-sm font-semibold text-[#eaf4ff] transition hover:bg-[#0f3d66] active:bg-[#0b2d4d] md:text-base"
            >
              Open My Profile
            </Link>
            ...
            <Link
              href="/all-books"
              className="inline-flex items-center justify-center rounded-xl border border-[#1f5d99] bg-transparent px-5 py-3 text-sm font-semibold text-[#1f5d99] transition hover:bg-[#93c5fd33] hover:text-[#0f3d66] active:bg-[#1f5d99] active:text-[#eaf4ff] md:text-base"
            >
              Explore More Titles
            </Link>
          </div>

          <div className="mt-6 rounded-xl border border-[#9ac5ee] bg-[#f2f8ff] px-4 py-4">
            <p className="text-xs uppercase tracking-[0.2em] text-[#1f5d99]">
              Tip Of The Day
            </p>
            <p className="mt-2 text-sm text-[#0f3d66] md:text-base">
              Borrow one high-rated book and one short book together to keep
              your reading pace balanced.
            </p>
          </div>
        </div>
      </section>
